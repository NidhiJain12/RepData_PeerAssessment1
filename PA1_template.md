...
2. **Fill in all of the missing values in the dataset**  
    ...
    ```
    ## [1] "New Activity Dataset with imputed missing values"
    ```
...
4. **Calculate and report the mean and median total number of steps taken per day for the new dataset**
    ...
    The mean of the total steps taken per day (after fixing missing values) is **10766.19**.  
    
    The median of the total steps taken per day (after fixing missing values) is **10766.19**. 
